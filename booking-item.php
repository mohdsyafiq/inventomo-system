              ...
              <div class="card">
                ...
                <div class="table-responsive text-nowrap">
                  <table class="table">
                    ...
                    <tbody>
                      <tr>
                        <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>BK-20349</strong></td>
                      ...
                      <tr>
                        <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>BK-20350</strong></td>
                        <td>Laptop Dell XPS</td>
                        <td>Aminah</td>
                      ...
                      <tr>
                        <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>BK-20351</strong></td>
                        <td>Laptop Dell XPS</td>
                        <td>Aminah</td>
                      ...
                      <tr>
                        <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>BK-20352</strong></td>
                        <td>Laptop Dell XPS</td>
                        <td>Aminah</td>
                        <td><span class="badge bg-label-success me-1">Complete</span></td>
                        <th>01-05-2024</th>
